...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', HS_CURRENT_THEME),
		'repeat-x'  => __('Repeat Horizontally', HS_CURRENT_THEME),
		'repeat-y'  => __('Repeat Vertically', HS_CURRENT_THEME),
		'repeat'    => __('Repeat All', HS_CURRENT_THEME),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', HS_CURRENT_THEME),
		'top center'    => __('Top Center', HS_CURRENT_THEME),
		'top right'     => __('Top Right', HS_CURRENT_THEME),
		'center left'   => __('Middle Left', HS_CURRENT_THEME),
		'center center' => __('Middle Center', HS_CURRENT_THEME),
		'center right'  => __('Middle Right', HS_CURRENT_THEME),
		'bottom left'   => __('Bottom Left', HS_CURRENT_THEME),
		'bottom center' => __('Bottom Center', HS_CURRENT_THEME),
		'bottom right'  => __('Bottom Right', HS_CURRENT_THEME)
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', HS_CURRENT_THEME),
		'fixed'  => __('Fixed in Place', HS_CURRENT_THEME)
		);
...
function of_recognized_font_lineheight() {
	$default = array(
		'1'        => __('1', HS_CURRENT_THEME),
		'1.2'        => __('1.2', HS_CURRENT_THEME),
		'1.5'        => __('1.5', HS_CURRENT_THEME),
		'2' => __('2', HS_CURRENT_THEME)
		);
...
function of_recognized_font_characters() {
	$default = array(
		...
		'latin-ext'		=> __('Latin Extended', HS_CURRENT_THEME),
		'greek'			=> __('Greek', HS_CURRENT_THEME),
		'greek-ext'		=> __('Greek Extended', HS_CURRENT_THEME),
		'cyrillic'		=> __('Cyrillic', HS_CURRENT_THEME),
		'cyrillic-ext'	=> __('Cyrillic Extended', HS_CURRENT_THEME),
...
function of_recognized_font_styles() {
	$default = array(
		...
		'bold italic' => __('Bold Italic', HS_CURRENT_THEME)
		);
	return apply_filters( 'of_recognized_font_styles', $default );
}
function of_recognized_font_weights() {
	$default = array(
		'100'      => __('Ultra-Light 100', HS_CURRENT_THEME),
		'200'      => __('Light 200', HS_CURRENT_THEME),
		'300'        => __('Book 300', HS_CURRENT_THEME),
		'400'      => __('Normal 400', HS_CURRENT_THEME),
		'500'      => __('Medium 500', HS_CURRENT_THEME),
		'600'        => __('Semi-Bold 600', HS_CURRENT_THEME),
		'700'      => __('Bold 700', HS_CURRENT_THEME),
		'800'      => __('Extra-Bold 800', HS_CURRENT_THEME),
		'900'        => __('Ultra-Bold 900', HS_CURRENT_THEME)
		);
...
function options_typography_get_os_fonts() {
	...
	$os_faces = array(
		...
		'playfair_displayregular' => 'Playfair Display Regular'
	);
	return $os_faces;
}
	...
	function options_typography_google_fonts() {
		...
		if (isset($hercules_font_array)) {
			foreach ($hercules_font_array as $key => $value) {
				switch ($hercules_font_array[$key]) {
					case 'Open+Sans+Condensed':
						$hercules_font_array[$key]= $hercules_font_array[$key].':300';
					break;
					default:
						//
					break;
...
function options_typography_enqueue_google_fonts($f, $ch) {
	wp_enqueue_style( "options_typography_$f", "http://fonts.googleapis.com/css?family=$f:100,200,300,400,500,600,700,800,900$ch", false, null, 'all' );
}
