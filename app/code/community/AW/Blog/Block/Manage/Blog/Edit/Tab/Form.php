...
class AW_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset ->addField(
            'show_thumbnail_in_home', 'checkbox', array(
            'label'     => Mage::helper('blog')->__('Show In Gallery Home Page'),
            'name'      => 'show_thumbnail_in_home',
            'onclick'   => 'this.value = this.checked ? 1 : 0;',
            'checked'  => Mage::registry('blog_data')->getShowThumbnailInHome() == 1 ? 'true' : 'false',
        ));//  'checked'   =>($this->getFeatured()==1)? 'true':'',
