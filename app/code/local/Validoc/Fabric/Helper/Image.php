...
class Validoc_Fabric_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     * Current model
     *
     * @var Validoc_Fabric_Model_Fabric_Image
     */
    protected $_model;
     ...
     * Current Fabric
     *
     * @var Validoc_Fabric_Model_Fabric
     */
    protected $_fabric;
     ...
     *
     * @return Validoc_Fabric_Helper_Image
     */
    ...
    public function init($fabric, $attributeName, $imageFile=null)
    {
        try {


            $this->_reset();
            $this->_setModel(Mage::getModel('validoc_fabric/fabric_image'));
            $this->_getModel()->setDestinationSubdir($attributeName);
            $this->setProduct($fabric);
            ...
            if ($imageFile) {
                ...
                $this->_getModel()->setBaseFile($this->getFabric()->getData($this->_getModel()->getDestinationSubdir()));
            }
        } catch(Exception $e) {
    ...
    public function __toString()
    {
        try {
            ...
            if ($this->getImageFile()) {
                ...
                $model->setBaseFile($this->getFabric()->getData($model->getDestinationSubdir()));
            }
    ...
    protected function setProduct($fabric)
    {
        $this->_fabric = $fabric;
        return $this;
    }

    protected function getFabric()
    {
        return $this->_fabric;
    }
