 ...
 */
class Validoc_Fabric_Model_Fabric_Image extends Mage_Catalog_Model_Product_Image
{
    /**
     * Set filenames for base file and new file
     *
     * @param string $file
     * @return Validoc_Fabric_Model_Fabric_Image
     */
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('validoc_fabric/fabric_media_config')->getBaseMediaPath();
        ...
        if ((!$file) || (!file_exists($baseFile))) {
            throw new Exception(Mage::helper('validoc_fabric')->__('Image file was not found.'));
        }
        ...
        $path = array(
            Mage::getSingleton('validoc_fabric/fabric_media_config')->getBaseMediaPath(),
            'cache',
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'validoc'.DS.'fabric'.DS.'cache'.DS;
