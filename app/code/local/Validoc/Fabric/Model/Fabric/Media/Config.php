 ...
 */
class Validoc_Fabric_Model_Fabric_Media_Config extends Mage_Catalog_Model_Product_Media_Config {
...
//        return 'tmp/' . $this->getBaseMediaUrlAddition();
    ...
    {
        return Mage::getBaseDir('media') . DS . 'validoc' . DS . 'fabric';
    }

    public function getBaseMediaUrl()
    {
        return Mage::getBaseUrl('media') . 'validoc/fabric';
    }
