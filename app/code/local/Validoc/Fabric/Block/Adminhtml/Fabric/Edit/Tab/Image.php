 ...
 * Time: 12:13 PM
 */
class Validoc_Fabric_Block_Adminhtml_Fabric_Edit_Tab_Image extends Mage_Adminhtml_Block_Widget {
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('validoc/fabric/edit/tab/image.phtml');
        $this->setId('fabric_image_gallery');
        $this->setHtmlId('fabric_image_gallery');
    }
    ...
    public function getImagesJson() {
        $_model = Mage::registry('current_fabric');
        ...
        if (is_array($_data) and sizeof($_data) > 0) {
            ...
            foreach ($_data as &$_item) {
                $_result[] = array(
                    'value_id'  => $_item['fabric_id'],
                    'url'       => Mage::getSingleton('validoc_fabric/fabric_media_config')->getBaseMediaUrl() . $_item['file'],
                    'file'      => $_item['file'],
                    'label'     => $_item['label'],
    ...
    public function getImagesValuesJson() {
        $values = array();
        $model = Mage::registry('current_fabric');
    ...
    public function getImageTypes() {
        ...
        $type['image']['field'] = "fabric[image]";
        
        $type['small_image']['label'] = "Small Image";
        $type['small_image']['field'] = "fabric[small_image]";

        $type['medium_image']['label'] = "Medium Image";
        $type['medium_image']['field'] = "fabric[medium_image]";
        
        $type['thumbnail']['label'] = "thumbnail";
        $type['thumbnail']['field'] = "fabric[thumbnail]";
