 ...
 * Time: 04:26 PM
 */
class Validoc_Fabric_Block_List_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Fabric collection
     *
    ...
    {
        return Mage::getSingleton('validoc_fabric/config');
    }
    ...
    protected function _construct()
    {
        ...
        //$this->_availableOrder = $this->getItensManufacturer();
        ...
        $this->setTemplate('validoc/fabric/list/toolbar.phtml');
    }
    ...
    /**
     * Return Fabric collection instance
     *
    ...
    /**
     * Get grit Fabric sort order field
     *
     * @return string
     */
    ...
    /**
     * Get specified Fabric limit display per page
     *
     * @return string
     */
    ...
    public function getPagerHtml()
    {
        ...
        if ($pagerBlock instanceof Varien_Object) {
            ...
            $pagerBlock->setUseContainer(false)
                ...
                ->setFrameLength(Mage::getStoreConfig('fabric/pagination/pagination_frame'))
                ->setJump(Mage::getStoreConfig('fabric/pagination/pagination_frame_skip'))
