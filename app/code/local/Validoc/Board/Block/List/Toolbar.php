 ...
 */
class Validoc_Board_Block_List_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Boards collection
     *
    ...
    {
        return Mage::getSingleton('validoc_board/config');
    }
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('validoc/board/list/toolbar.phtml');
    }
    ...
    /**
     * Return Boards collection instance
     *
    ...
    /**
     * Get grit Boards sort order field
     *
     * @return string
     */
    ...
    /**
     * Get specified Boards limit display per page
     *
     * @return string
     */
