 ...
 * Time: 12:13 PM
 */
class Validoc_Board_Block_Adminhtml_Board_Edit_Tab_Image extends Mage_Adminhtml_Block_Widget {
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('validoc/board/edit/tab/image.phtml');
        $this->setId('board_image_gallery');
        $this->setHtmlId('board_image_gallery');
    }
    ...
    public function getImagesJson() {
        $_model = Mage::registry('current_board');
        ...
        if (is_array($_data) and sizeof($_data) > 0) {
            ...
            foreach ($_data as &$_item) {
                $_result[] = array(
                    'value_id'  => $_item['board_id'],
                    'url'       => Mage::getSingleton('validoc_board/board_media_config')->getBaseMediaUrl() . $_item['file'],
                    'file'      => $_item['file'],
                    'label'     => $_item['label'],
    ...
    public function getImagesValuesJson() {
        $values = array();
        $model = Mage::registry('current_board');
    ...
    public function getImageTypes() {
        ...
        $type['image']['field'] = "board[image]";
        
        $type['small_image']['label'] = "Small Image";
        $type['small_image']['field'] = "board[small_image]";

        $type['medium_image']['label'] = "Medium Image";
        $type['medium_image']['field'] = "board[medium_image]";
        
        $type['thumbnail']['label'] = "thumbnail";
        $type['thumbnail']['field'] = "board[thumbnail]";
