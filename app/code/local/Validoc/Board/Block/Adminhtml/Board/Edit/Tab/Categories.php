 ...
 */
class Validoc_Board_Block_Adminhtml_Board_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('validoc/board/edit/tab/categories.phtml');
