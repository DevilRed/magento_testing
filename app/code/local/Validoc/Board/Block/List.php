 ...
 * Time: 1:16 AM
 */
class Validoc_Board_Block_List extends Mage_Core_Block_Template
{

    /**
     * Board amount per row depending on custom page layout of category
     *
     * @var array
     */
     ...
     */
    protected function _getBoardCollection()
    {
        if (is_null($this->_boardCollection)) {
            $this->_boardCollection = Mage::getModel("validoc_board/board")->getCollection();
        }
     ...
     * @return Mage_Eav_Model_Entity_Collection_Abstract
     */
    public function getLoadedBoardCollection()
    {
        return $this->_getBoardCollection();
    }
    ...
    protected function _beforeToHtml()
    {
        ...
        $collection = $this->_getBoardCollection();
    ...
    {
        $this->_boardCollection = $collection;
        return $this;
    }

    public function addField($code)
    {
        $this->_getBoardCollection()->addFieldToSelect($code);
        return $this;
    }
