...
class Validoc_Board_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     * Current model
     *
     * @var Validoc_Board_Model_Board_Image
     */
    protected $_model;
     ...
     *
     * @return Validoc_Board_Helper_Image
     */
    ...
    public function init($board, $attributeName, $imageFile=null)
    {
        try {


            $this->_reset();
            $this->_setModel(Mage::getModel('validoc_board/board_image'));
            $this->_getModel()->setDestinationSubdir($attributeName);
            $this->setProduct($board);
            ...
            if ($imageFile) {
                ...
                $this->_getModel()->setBaseFile($this->getBoard()->getData($this->_getModel()->getDestinationSubdir()));
            }
        } catch(Exception $e) {
    ...
    public function __toString()
    {
        try {
            ...
            if ($this->getImageFile()) {
                ...
                $model->setBaseFile($this->getBoard()->getData($model->getDestinationSubdir()));
            }
    ...
    protected function setProduct($board)
    {
        $this->_board = $board;
        return $this;
    }
