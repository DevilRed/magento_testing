 ...
 */
class Validoc_Board_Model_Board_Media_Config extends Mage_Catalog_Model_Product_Media_Config {
...
//        return 'tmp/' . $this->getBaseMediaUrlAddition();
    ...
    {
        return Mage::getBaseDir('media') . DS . 'validoc' . DS . 'board';
    }

    public function getBaseMediaUrl()
    {
        return Mage::getBaseUrl('media') . 'validoc/board';
    }
