 ...
 * Time: 12:13 PM
 */
class Validoc_Floorplan_Block_Adminhtml_Floorplan_Edit_Tab_Image extends Mage_Adminhtml_Block_Widget {
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('validoc/floorplan/edit/tab/image.phtml');
        $this->setId('floorplan_image_gallery');
        $this->setHtmlId('floorplan_image_gallery');
    }
    ...
    public function getImagesJson() {
        $_model = Mage::registry('current_floorplan');
        ...
        if (is_array($_data) and sizeof($_data) > 0) {
            ...
            foreach ($_data as &$_item) {
                $_result[] = array(
                    'value_id'  => $_item['floorplan_id'],
                    'url'       => Mage::getSingleton('validoc_floorplan/floorplan_media_config')->getBaseMediaUrl() . $_item['file'],
                    'file'      => $_item['file'],
                    'label'     => $_item['label'],
    ...
    public function getImagesValuesJson() {
        $values = array();
        $model = Mage::registry('current_floorplan');
    ...
    public function getImageTypes() {
        ...
        $type['image']['field'] = "floorplan[image]";
        
        $type['small_image']['label'] = "Small Image";
        $type['small_image']['field'] = "floorplan[small_image]";

        $type['medium_image']['label'] = "Medium Image";
        $type['medium_image']['field'] = "floorplan[medium_image]";
        
        $type['thumbnail']['label'] = "thumbnail";
        $type['thumbnail']['field'] = "floorplan[thumbnail]";
