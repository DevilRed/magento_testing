 ...
 * Time: 1:16 AM
 */
class Validoc_Floorplan_Block_List extends Mage_Core_Block_Template
{

    /**
     * Floorplan amount per row depending on custom page layout of category
     *
     * @var array
     */
     ...
     */
    protected $_floorplanCollection;
     ...
     */
    protected function _getFloorplanCollection()
    {
        if (is_null($this->_floorplanCollection)) {
            $this->_floorplanCollection = Mage::getModel("validoc_floorplan/floorplan")->getCollection();
        }

        return $this->_floorplanCollection;
    }
     ...
     * @return Mage_Eav_Model_Entity_Collection_Abstract
     */
    public function getLoadedFloorplanCollection()
    {
        return $this->_getFloorplanCollection();
    }
    ...
    protected function _beforeToHtml()
    {
        ...
        $collection = $this->_getFloorplanCollection();
        ...
        $this->_getFloorplanCollection()->load();
    ...
    {
        $this->_floorplanCollection = $collection;
        return $this;
    }

    public function addField($code)
    {
        $this->_getFloorplanCollection()->addFieldToSelect($code);
        return $this;
    }
