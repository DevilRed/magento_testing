<?php
/**
 * Floorplan list toolbar
 *
 * @category    Mage
 * @package     Mage_Catalog
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Validoc_Floorplan_Block_List_Toolbar extends Mage_Core_Block_Template
{
    /**
    ...
    {
        return Mage::getSingleton('validoc_floorplan/config');
    }
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('validoc/floorplan/list/toolbar.phtml');
    }
    ...
    /**
     * Return Floorplans collection instance
     *
    ...
    /**
     * Get grit Floorplans sort order field
     *
     * @return string
     */
    ...
    /**
     * Get specified Floorplans limit display per page
     *
     * @return string
     */
