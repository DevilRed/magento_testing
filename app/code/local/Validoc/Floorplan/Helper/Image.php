...
class Validoc_Floorplan_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     * Current model
     *
     * @var Validoc_Floorplan_Model_Floorplan_Image
     */
    protected $_model;
     ...
     * Current Floorplan
     *
     * @var Validoc_Floorplan_Model_Floorplan
     */
    protected $_floorplan;
     ...
     *
     * @return Validoc_Floorplan_Helper_Image
     */
    ...
    public function init($floorplan, $attributeName, $imageFile=null)
    {
        try {


            $this->_reset();
            $this->_setModel(Mage::getModel('validoc_floorplan/floorplan_image'));
            $this->_getModel()->setDestinationSubdir($attributeName);
            $this->setProduct($floorplan);
            ...
            if ($imageFile) {
                ...
                $this->_getModel()->setBaseFile($this->getFloorplan()->getData($this->_getModel()->getDestinationSubdir()));
            }
        } catch(Exception $e) {
    ...
    public function __toString()
    {
        try {
            ...
            if ($this->getImageFile()) {
                ...
                $model->setBaseFile($this->getFloorplan()->getData($model->getDestinationSubdir()));
            }
    ...
    protected function setProduct($floorplan)
    {
        $this->_floorplan = $floorplan;
        return $this;
    }

    protected function getFloorplan()
    {
