 ...
 */
class Validoc_Floorplan_Model_Floorplan_Image extends Mage_Catalog_Model_Product_Image
{
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('validoc_floorplan/floorplan_media_config')->getBaseMediaPath();
        ...
        if ((!$file) || (!file_exists($baseFile))) {
            throw new Exception(Mage::helper('validoc_floorplan')->__('Image file was not found.'));
        }
        ...
        $path = array(
            Mage::getSingleton('validoc_floorplan/floorplan_media_config')->getBaseMediaPath(),
            'cache',
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'validoc'.DS.'floorplan'.DS.'cache'.DS;
