...
/**
 * Class Validoc_Designer_Helper_Image
 */
class Validoc_Designer_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     * Current model
     *
     * @var Validoc_Designer_Model_Designer_Image
     */
    protected $_model;
     ...
     * Current Board
     *
     * @var Validoc_Designer_Model_Designer
     */
    protected $_designer;
     ...
     *
     * @return Validoc_Designer_Helper_Image
     */
    ...
    public function init($designer, $attributeName, $imageFile=null)
    {
        try {
            $this->_reset();
            $this->_setModel(Mage::getModel('validoc_designer/designer_image'));
            $this->_getModel()->setDestinationSubdir($attributeName);
            $this->setProduct($designer);
            ...
            if ($imageFile) {
                ...
                $this->_getModel()->setBaseFile($this->getDesigner()->getData($this->_getModel()->getDestinationSubdir()));
            }
        } catch(Exception $e) {
    ...
    public function __toString()
    {
        try {
            ...
            if ($this->getImageFile()) {
                ...
                $model->setBaseFile($this->getDesigner()->getData($model->getDestinationSubdir()));
            }
    ...
    protected function setProduct($designer)
    {
        $this->_designer = $designer;
        return $this;
    }

    protected function getDesigner()
    {
