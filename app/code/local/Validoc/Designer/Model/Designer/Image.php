 ...
 */
class Validoc_Designer_Model_Designer_Image extends Mage_Catalog_Model_Product_Image
{
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('validoc_designer/designer_media_config')->getBaseMediaPath();
        ...
        if ((!$file) || (!file_exists($baseFile))) {
            throw new Exception(Mage::helper('validoc_designer')->__('Image file was not found.'));
        }
        ...
        $path = array(
            Mage::getSingleton('validoc_designer/designer_media_config')->getBaseMediaPath(),
            'cache',
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'validoc'.DS.'designer'.DS.'cache'.DS;
