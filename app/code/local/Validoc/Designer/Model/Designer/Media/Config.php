 ...
 */
class Validoc_Designer_Model_Designer_Media_Config extends Mage_Catalog_Model_Product_Media_Config {
...
//        return 'tmp/' . $this->getBaseMediaUrlAddition();
    ...
    {
        return Mage::getBaseDir('media') . DS . 'validoc' . DS . 'designer';
    }

    public function getBaseMediaUrl()
    {
        return Mage::getBaseUrl('media') . 'validoc/designer';
    }
