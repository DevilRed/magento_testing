<?php
/**
 * Designer list toolbar
 *
 * @category    Mage
 * @package     Mage_Catalog
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Validoc_Designer_Block_List_Toolbar extends Mage_Core_Block_Template
{
    /**
    ...
    {
        return Mage::getSingleton('validoc_designer/config');
    }
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('validoc/designer/list/toolbar.phtml');
    }
    ...
    /**
     * Return Designers collection instance
     *
    ...
    /**
     * Get grit Designers sort order field
     *
     * @return string
     */
    ...
    /**
     * Get specified Designers limit display per page
     *
     * @return string
     */
